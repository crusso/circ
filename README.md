...
Illustrates using custom project types with pre-declared candid interface and custom build rules to compile mutually recursive Motoko actors. See `dfx.json` and `builda.sh`, `buildb.sh`.
